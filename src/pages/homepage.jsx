        ...
        <div>
          <div className=" flex  lg:flex-row md:flex-row flex-col bg-[#F6F8FC] lg:!pt-30 !pt-20  ">
            <div className=" lg:!px-15 md:!px-10 !px-10 w-full ">
              ...
              <p className="text-[#262626] lg:text-[100px] md:text-[60px] text-[40px] font-semibold lg:leading-32 md:leading-20 leading-15">
                Collabration.
              </p>
              <p className="text-[#0938D3] lg:text-[100px] md:text-[60px] text-[40px] font-semibold lg:leading-32 md:leading-12 leading-10">
                Development.
              </p>
              <div>
            ...
            <div className="flex flex-col lg:w-1/2 md:w-full w-full justify-center lg:!px-15 md:!px-10  ">
              ...
              <div className="!pb-10">
                ...
                <p className="lg:text-[20px] md:text-[18px] text-[16px]  text-[#696969] font-manrope lg:leading-10 md:leading-10 leading-8 text-justify">
                  ...
                  experience. Every line of code and pixel of design is crafted
                  to meet user needs and exceed expectations.Our focus is on
            ...
            <div className="flex flex-col md:w-full w-full justify-center ">
              ...
              <div className="lg:!pb-20 md:!pb-20">
                ...
                <p className="lg:text-[20px] md:text-[18px] text-[16px]  text-[#696969] font-manrope lg:leading-10 md:leading-10 leading-6 text-justify !py-4">
                  At our core, we help businesses grow by crafting robust
                  digital products and offering dependable, end-to-end services.
                  Whether you're a startup aiming for rapid growth or an
                  established enterprise looking to modernize, our mission is to
                  turn your vision into scalable, high-performing software.
                </p>

                <p className="lg:text-[20px] md:text-[18px] text-[16px]  text-[#696969] font-manrope lg:leading-10 md:leading-10 leading-6 text-justify !py-4">
                  With a team of seasoned experts in full-stack development,
                  design, and strategic consulting, we bring years of
                  cross-industry experience to every project. From the first
                  wireframe to the final line of code, we ensure your digital
                  product is not just built—but built right.
                </p>
              </div>
            </div>
